...
# Get Stick/Arc settings
python welder_tools.py arc <material> <thickness>

# Get wire speed
python welder_tools.py wire <material> <size> <thickness_category>
...
## Materials Reference
- `mild_steel` - Low carbon structural steel
- `stainless_steel` - 304/316 grade stainless
- `aluminum` - 6061, 5052, 7075 alloys
- `cast_iron` - Gray cast iron repair
